package edu.ucsb.cs56.S13.drawings.hkailahi.simple;
...
/**
   ...
   @author Heneli Kailahi (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Heneli Kailahi", 20,40);
    }
